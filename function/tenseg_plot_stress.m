function [fig_out] = tenseg_plot_stress( N,C_b,C_s,fig_handle,highlight_nodes,view_vec, PlotTitle, R3Ddata,strut_s)
...
if ~isempty(C_b)&(isfield(strut_s,'stress'))
    B = N*C_b';
...
if ~isempty(C_s)&isfield(strut_s,'stress')
    S = N*C_s';
